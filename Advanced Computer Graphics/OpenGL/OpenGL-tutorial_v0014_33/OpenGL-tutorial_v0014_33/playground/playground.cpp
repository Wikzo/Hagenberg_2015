...
int main(void)
{
	...
	GLuint programID = LoadShaders("MySimpleVertexShader.vertexshader", "MySimpleFragmentShader.fragmentshader");
	...
	static const GLfloat g_vertex_buffer_data[] = {
		-1.0f, -1.0f, 0.0f, // vector 1 (bottom left corner)
		1.0f, -1.0f, 0.0f, // vector 2 (bottom right corner)
		0.0f, 1.0f, 0.0f, // vector 3 (top center)
	};
