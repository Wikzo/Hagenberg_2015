...
public class SpringComponen_old extends PhysicsBody implements IDebugRenderable
{
	...
	public SpringComponen_old SetDamp(float damp)
	{
		_dampConstant = damp;
		return this;
	}
	
	public SpringComponen_old SetSpringConstant(float constant)
	{
